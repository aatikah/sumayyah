            ...
            steps {
                script {
                    ...
                    //sh '''
                      ...
                      //  '''
                    sh '''
                          docker run --rm -v /home/jenkins/workspace/django:/path zricethezav/gitleaks:latest detect --source /path --report-format json --report-path /path/gitleaks-report.json --no-git
                        '''
